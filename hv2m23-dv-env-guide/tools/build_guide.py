...
.script-table { min-width: 1280px !important; table-layout: fixed; }
.script-table th:nth-child(1), .script-table td:nth-child(1) { width: 285px; }
.script-table th:nth-child(2), .script-table td:nth-child(2) { width: 355px; }
.script-table th:nth-child(3), .script-table td:nth-child(3) { width: 285px; }
.script-table th:nth-child(4), .script-table td:nth-child(4) { width: 355px; }
.script-table td { overflow-wrap: anywhere; word-break: normal; }
.script-table code { white-space: normal; overflow-wrap: anywhere; word-break: break-word; }
...
def build_svgs() -> None:
    ...
    architecture = """
      <rect class="box" x="20" y="20" width="1360" height="830" rx="10"/><text class="ink" x="42" y="50">chip_tb_top / UVM testbench hierarchy</text>
      <rect class="blue dash" x="45" y="70" width="1310" height="590" rx="10"/><text class="ink" x="65" y="98">uvm_test_top : concrete testcase extends base_test</text>

      <rect class="purple" x="75" y="125" width="190" height="80" rx="7"/><text class="ink" x="170" y="153" text-anchor="middle">base_vseq</text><text class="small" x="170" y="178" text-anchor="middle">ISPTX sequence[0..3]</text><text class="small" x="170" y="198" text-anchor="middle">selected by CONNECT_NUM</text>
      <rect class="green" x="310" y="125" width="180" height="80" rx="7"/><text class="ink" x="400" y="153" text-anchor="middle">sd_vsqr</text><text class="small" x="400" y="178" text-anchor="middle">p_isptx_sqr[0..3]</text><text class="small" x="400" y="198" text-anchor="middle">p_i2c_sqr[0..3]</text>
      <rect class="amber" x="535" y="125" width="180" height="80" rx="7"/><text class="ink" x="625" y="153" text-anchor="middle">rx_cfg[0..3]</text><text class="small" x="625" y="178" text-anchor="middle">frame / protocol / id</text><text class="small" x="625" y="198" text-anchor="middle">checker enable gates</text>
      <rect class="box" x="760" y="125" width="180" height="80" rx="7"/><text class="ink" x="850" y="153" text-anchor="middle">digital_coverage</text><text class="small" x="850" y="178" text-anchor="middle">cov_comp</text><text class="small" x="850" y="198" text-anchor="middle">coverage collection</text>
      <rect class="amber" x="985" y="125" width="325" height="80" rx="7"/><text class="ink" x="1147" y="153" text-anchor="middle">CONNECT_NUM = 1..4</text><text class="small" x="1147" y="178" text-anchor="middle">creates sd_env, sd_env_1, sd_env_2, sd_env_3</text><text class="small" x="1147" y="198" text-anchor="middle">and binds the matching sequencer/interface index</text>
      <path class="arrow" d="M265 165 H310"/><path class="arrow-orange dash" d="M535 165 H490"/>

      <rect class="amber dash" x="75" y="240" width="1235" height="380" rx="10"/><text class="ink" x="95" y="270">source_driver_env : sd_env[i] (one instance per active connection)</text>
      <rect class="blue dash" x="105" y="300" width="260" height="245" rx="8"/><text class="ink" x="125" y="328">isptx_agt : isptx_agent</text>
      <rect class="green" x="135" y="355" width="200" height="55" rx="6"/><text class="ink" x="235" y="388" text-anchor="middle">sqr : isptx_sequencer</text>
      <rect class="blue" x="135" y="435" width="200" height="70" rx="6"/><text class="ink" x="235" y="465" text-anchor="middle">drv : isptx_driver</text><text class="small" x="235" y="490" text-anchor="middle">9-bit symbol -> rxp/rxn</text>
      <path class="arrow" d="M235 410 V435"/>

      <rect class="blue dash" x="405" y="300" width="260" height="245" rx="8"/><text class="ink" x="425" y="328">i2c_agt : i2c_agent</text>
      <rect class="green" x="435" y="355" width="200" height="55" rx="6"/><text class="ink" x="535" y="388" text-anchor="middle">i2c_sqr : sequencer</text>
      <rect class="blue" x="435" y="435" width="90" height="70" rx="6"/><text class="ink" x="480" y="465" text-anchor="middle">driver</text><text class="small" x="480" y="490" text-anchor="middle">SDA/SCL</text>
      <rect class="green" x="545" y="435" width="90" height="70" rx="6"/><text class="ink" x="590" y="465" text-anchor="middle">monitor</text><text class="small" x="590" y="490" text-anchor="middle">I2C observe</text>
      <path class="arrow" d="M535 410 V425 H480 V435"/><path class="arrow-green" d="M590 505 V525"/>

      <rect class="purple dash" x="705" y="300" width="575" height="285" rx="8"/><text class="ink" x="725" y="328">ck_agent : checker_agent (all components created; gates act internally)</text>
      <rect class="blue" x="735" y="355" width="245" height="190" rx="7"/><text class="ink" x="857" y="382" text-anchor="middle">DUT tap monitors</text><text class="small" x="857" y="410" text-anchor="middle">data_merge_monitor (2 streams)</text><text class="small" x="857" y="434" text-anchor="middle">digital_top_monitor (4 streams)</text><text class="small" x="857" y="458" text-anchor="middle">chopper_monitor (D connected)</text><text class="small" x="857" y="482" text-anchor="middle">analog_data_output_monitor (5 paths)</text><text class="small" x="857" y="506" text-anchor="middle">DRD input + output monitors</text><text class="small" x="857" y="530" text-anchor="middle">analysis_port -></text>
      <rect class="amber" x="1010" y="355" width="240" height="190" rx="7"/><text class="ink" x="1130" y="382" text-anchor="middle">Scoreboards</text><text class="small" x="1130" y="410" text-anchor="middle">Data Merge scoreboard</text><text class="small" x="1130" y="434" text-anchor="middle">Digital Top scoreboard</text><text class="small" x="1130" y="458" text-anchor="middle">Chopper scoreboard</text><text class="small" x="1130" y="482" text-anchor="middle">Analog/control scoreboard</text><text class="small" x="1130" y="506" text-anchor="middle">DRD input + output scoreboards</text><text class="small" x="1130" y="530" text-anchor="middle">golden compare / UVM error</text>
      <path class="arrow-green" d="M980 450 H1010"/>

      <path class="arrow" d="M400 205 V225 H235 V355 M400 225 H535 V355"/><path class="arrow-orange dash" d="M625 205 V285 H235 V300 M625 285 H535 V300 M625 285 H992 V300"/>

      <rect class="box dash" x="45" y="690" width="1310" height="125" rx="8"/><text class="ink" x="65" y="718">Static HDL domain / models</text>
      <rect class="blue" x="85" y="740" width="245" height="50" rx="6"/><text class="ink" x="207" y="771" text-anchor="middle">isptx_if[i] -> APAD_RXP/RXN</text>
      <rect class="amber" x="385" y="740" width="210" height="50" rx="6"/><text class="ink" x="490" y="771" text-anchor="middle">i2c_if[i] + i2c_model</text>
      <rect class="green" x="650" y="730" width="310" height="70" rx="6"/><text class="ink" x="805" y="758" text-anchor="middle">u_HV2M23 DUT</text><text class="small" x="805" y="782" text-anchor="middle">RX -> merge -> digital -> chopper -> analog</text>
      <rect class="purple" x="1015" y="730" width="300" height="70" rx="6"/><text class="ink" x="1165" y="758" text-anchor="middle">checker tap interfaces</text><text class="small" x="1165" y="782" text-anchor="middle">config_db -> monitor virtual interfaces</text>
      <path class="arrow" d="M235 505 V740 M480 505 V690 H490 V740"/><path class="arrow" d="M330 765 V720 H625 V748 H650 M595 780 H650"/><path class="arrow-green" d="M960 765 H1015 M1165 730 V650 H857 V545"/>
      <g transform="translate(70 875)"><path class="arrow" d="M0 8 H28"/><text class="small" x="36" y="12">sequence / driven traffic</text><path class="arrow-green" d="M260 8 H288"/><text class="small" x="296" y="12">sampled data / analysis path</text><path class="arrow-orange dash" d="M590 8 H618"/><text class="small" x="626" y="12">configuration / config_db</text></g>
    """
    flow = """
    ...
    isptx_sequence_detail = """
      <rect class="green dash" x="20" y="20" width="1120" height="1210" rx="14"/><text class="ink" x="45" y="52">ISPTX TX execution: isptx_sequence_1.sv</text>
      <rect class="box" x="45" y="75" width="1070" height="105" rx="8"/><text class="ink" x="70" y="105">1. body() :1104-1122 - resolve runtime context</text><text class="small" x="70" y="132">MULTI_CHIP ? get rx_cfg1 : get rx_cfg; get virtual isptx_if as vif1</text><text class="small" x="70" y="154">read +SIM_TEST_PATH and +FILE_PATH; lane_total_number = htotal*3/port_num/lane_num; call send_isp()</text><path class="arrow" d="M580 180 V205"/>

      <rect class="box" x="45" y="205" width="1070" height="225" rx="8"/><text class="ink" x="70" y="235">2. send_isp() FSM :1028-1102 - link training, unlock monitoring and retry</text>
      <rect class="blue" x="75" y="265" width="285" height="120" rx="8"/><text class="ink" x="217" y="295" text-anchor="middle">TRAIN_SEND</text><text class="small" x="217" y="322" text-anchor="middle">reverse TBK1/TBK2; send LANE_NUM</text><text class="small" x="217" y="345" text-anchor="middle">TYPE_TRAINING / _TWO</text><text class="small" x="217" y="368" text-anchor="middle">fork 33 ms timeout; join_any</text>
      <rect class="blue" x="425" y="265" width="335" height="120" rx="8"/><text class="ink" x="592" y="295" text-anchor="middle">TRAIN_ACTIVE</text><text class="small" x="592" y="322" text-anchor="middle">fork drv_ppm and mon_unlock</text><text class="small" x="592" y="345" text-anchor="middle">optional BWDA dummy -> send_ppm()</text><text class="small" x="592" y="368" text-anchor="middle">PAD_LOCK_LEFT_IO==0 -> retry or stop</text>
      <rect class="box" x="825" y="265" width="255" height="120" rx="8"/><text class="ink" x="952" y="295" text-anchor="middle">DRV_PPM_DONE</text><text class="small" x="952" y="322" text-anchor="middle">send_ppm complete, or</text><text class="small" x="952" y="345" text-anchor="middle">unlock_time &gt; 21</text><text class="small" x="952" y="368" text-anchor="middle">break while loop</text>
      <path class="arrow" d="M360 325 H425 M760 325 H825"/><path class="arrow-orange dash" d="M592 385 V410 H217 V385"/><text class="small" x="315" y="423">unlock_time 1..21 -> TRAIN_SEND</text><path class="arrow" d="M592 430 V455"/>

      <rect class="purple dash" x="45" y="455" width="1070" height="740" rx="10"/><text class="ink" x="70" y="487">3. send_ppm() :423-1026 - for frame c = 0 .. rx_cfg.frame_num-1</text>
      <rect class="box" x="75" y="515" width="310" height="120" rx="8"/><text class="ink" x="230" y="545" text-anchor="middle">3.1 Frame setup</text><text class="small" x="230" y="572" text-anchor="middle">bac_pol_error -> POL symbols</text><text class="small" x="230" y="595" text-anchor="middle">file = pattern/frame_c.ppm</text><text class="small" x="230" y="618" text-anchor="middle">even frame POL=1; odd frame POL=0</text>
      <rect class="amber" x="425" y="515" width="310" height="120" rx="8"/><text class="ink" x="580" y="545" text-anchor="middle">3.2 VBP / setting lines</text><text class="small" x="580" y="572" text-anchor="middle">c==0: first_frame_setting_line</text><text class="small" x="580" y="595" text-anchor="middle">later: setting_line + remaining VBP</text><text class="small" x="580" y="618" text-anchor="middle">HBK -> BKPOL(even/odd) -> HFP</text>
      <rect class="amber" x="775" y="515" width="310" height="120" rx="8"/><text class="ink" x="930" y="545" text-anchor="middle">send_register() :311-414</text><text class="small" x="930" y="572" text-anchor="middle">get_reg(frame) -> encode 8B to 9B</text><text class="small" x="930" y="595" text-anchor="middle">HBP -> BAC -> SETTING -> 72 regs</text><text class="small" x="930" y="618" text-anchor="middle">EOL/BKPOL -> HFP; 1L/2L IDs</text>
      <path class="arrow" d="M385 575 H425 M735 575 H775"/>

      <rect class="green" x="75" y="675" width="310" height="155" rx="8"/><text class="ink" x="230" y="705" text-anchor="middle">3.3 Pixel source branch</text><text class="small" x="230" y="732" text-anchor="middle">OD_k != 0: allocate 8 arrays</text><text class="small" x="230" y="755" text-anchor="middle">drdod_generate_pixel_data()</text><text class="small" x="230" y="778" text-anchor="middle">encode data0/1 8B9B; data2..7=0</text><text class="small" x="230" y="806" text-anchor="middle">else: scramble map + DPI load_ppm()</text>
      <rect class="box" x="425" y="675" width="310" height="155" rx="8"/><text class="ink" x="580" y="705" text-anchor="middle">3.4 Remap / line padding</text><text class="small" x="580" y="732" text-anchor="middle">subpix modes 000/011/110/111</text><text class="small" x="580" y="755" text-anchor="middle">DPLC + 2-lane odd/even swap</text><text class="small" x="580" y="778" text-anchor="middle">PAIR_NUM branch; append 3 or 6 symbols</text><text class="small" x="580" y="806" text-anchor="middle">UTC / inject / channel-specific paths</text>
      <rect class="purple" x="775" y="675" width="310" height="155" rx="8"/><text class="ink" x="930" y="705" text-anchor="middle">3.5 exec_c(c, frame POL)</text><text class="small" x="930" y="732" text-anchor="middle">even c -> pol=1; odd c -> pol=0</text><text class="small" x="930" y="755" text-anchor="middle">generate SD / DPLC / DRDOD artifacts</text><text class="small" x="930" y="778" text-anchor="middle">details in right-hand source audit</text><text class="small" x="930" y="806" text-anchor="middle">then enter VACT loop</text>
      <path class="arrow" d="M580 635 V655 H230 V675 M580 655 V675 M580 655 H930 V675"/>

      <rect class="blue" x="75" y="870" width="485" height="205" rx="8"/><text class="ink" x="317" y="900" text-anchor="middle">3.6 VACT: for line j = 0 .. vact-1</text><text class="small" x="317" y="928" text-anchor="middle">HBP: normal count or EOL2BAC/BAC_BAC branch</text><text class="small" x="317" y="952" text-anchor="middle">optional c==1 HBK dummy-bit injection</text><text class="small" x="317" y="976" text-anchor="middle">BAC -> POL(even/odd) -> for subpixel i</text><text class="small" x="317" y="1000" text-anchor="middle">1 lane: TYPE_PIXEL_LINE(data); 2 lane: merge two_data</text><text class="small" x="317" y="1024" text-anchor="middle">PIX_INSERT / error_hsync exception branches</text><text class="small" x="317" y="1048" text-anchor="middle">EOL -> HFP; hbk_scr_en around blank transaction</text>
      <rect class="box" x="600" y="870" width="485" height="205" rx="8"/><text class="ink" x="842" y="900" text-anchor="middle">3.7 VFP and frame completion</text><text class="small" x="842" y="928" text-anchor="middle">repeat rx_cfg.vfp blank lines</text><text class="small" x="842" y="952" text-anchor="middle">each: HBP -> BKPOL -> HFP</text><text class="small" x="842" y="976" text-anchor="middle">BKPOL_1 for even frame; BKPOL_0 for odd</text><text class="small" x="842" y="1000" text-anchor="middle">log Frame c done; increment c</text><text class="small" x="842" y="1024" text-anchor="middle">after final frame return to TRAIN_ACTIVE</text><text class="small" x="842" y="1048" text-anchor="middle">next_state = DRV_PPM_DONE</text>
      <path class="arrow" d="M930 830 V850 H317 V870 M930 850 H842 V870"/><path class="arrow-orange dash" d="M842 1075 V1140 H58 V575 H75"/><text class="small" x="390" y="1133">next frame: reload cfg/pattern and toggle POL</text>

      <rect class="green dash" x="1170" y="20" width="410" height="1210" rx="14"/><text class="ink" x="1195" y="52">exec_c() source audit :56-145</text>
      <rect class="box" x="1200" y="80" width="350" height="150" rx="8"/><text class="ink" x="1375" y="110" text-anchor="middle">A. Build three commands</text><text class="small" x="1375" y="138" text-anchor="middle">pic_process: W/H/P/subpix/DOTC</text><text class="small" x="1375" y="161" text-anchor="middle">POL/POLC/SHL/H120V/DPLC_MODE</text><text class="small" x="1375" y="184" text-anchor="middle">dplc.pl: mode/AVE/delta/last</text><text class="small" x="1375" y="207" text-anchor="middle">drdod_process.py: panel/OD_k/w1..w6/gray</text>
      <path class="arrow-green" d="M1375 230 V265"/>
      <rect class="amber" x="1200" y="265" width="350" height="180" rx="8"/><text class="ink" x="1375" y="295" text-anchor="middle">B. if DPLC_MODE == 1</text><text class="small" x="1375" y="323" text-anchor="middle">current active mode = duplicate</text><text class="small" x="1375" y="347" text-anchor="middle">AVE_DELTA maps 0/1/2/3</text><text class="small" x="1375" y="371" text-anchor="middle">run dplc.pl -> DPLC_model.log</text><text class="small" x="1375" y="395" text-anchor="middle">run pic_process -> SD_model.log</text><text class="small" x="1375" y="423" text-anchor="middle">then continue to unconditional calls</text>
      <path class="arrow-green" d="M1375 445 V480"/>
      <rect class="purple" x="1200" y="480" width="350" height="155" rx="8"/><text class="ink" x="1375" y="510" text-anchor="middle">C. Always executed</text><text class="small" x="1375" y="538" text-anchor="middle">pic_process -> SD_model.log</text><text class="small" x="1375" y="562" text-anchor="middle">drdod_process.py -> drdod.log</text><text class="small" x="1375" y="586" text-anchor="middle">there is no OD_k condition here</text><text class="small" x="1375" y="610" text-anchor="middle">DPLC mode runs pic_process twice</text>
      <path class="arrow-green" d="M1375 635 V670"/>
      <rect class="green" x="1200" y="670" width="350" height="210" rx="8"/><text class="ink" x="1375" y="700" text-anchor="middle">D. Produced artifacts</text><text class="small" x="1375" y="730" text-anchor="middle">outResult[/id]/data_merge/*.txt</text><text class="small" x="1375" y="754" text-anchor="middle">outResult[/id]/digital/*.txt</text><text class="small" x="1375" y="778" text-anchor="middle">outResult[/id]/analog/*.txt</text><text class="small" x="1375" y="802" text-anchor="middle">DPLC_frameN_idM.ppm</text><text class="small" x="1375" y="826" text-anchor="middle">drdod_out_frameN.ppm</text><text class="small" x="1375" y="850" text-anchor="middle">scoreboards load by frame / id / mode</text>
      <rect class="amber dash" x="1200" y="930" width="350" height="245" rx="8"/><text class="ink" x="1375" y="960" text-anchor="middle">Source-level review notes</text><text class="small" x="1375" y="992" text-anchor="middle">exec_c is called after pixel arrays/remap</text><text class="small" x="1375" y="1018" text-anchor="middle">DRDOD command consumes input_ppm actual</text><text class="small" x="1375" y="1044" text-anchor="middle">all system return codes are currently ignored</text><text class="small" x="1375" y="1070" text-anchor="middle">model failure can leave stale/missing artifacts</text><text class="small" x="1375" y="1096" text-anchor="middle">recommended: check $system status and files</text><text class="small" x="1375" y="1122" text-anchor="middle">DPLC duplicate pic_process call needs review</text><text class="small" x="1375" y="1148" text-anchor="middle">diagram reflects current source, not intent</text>
      <path class="arrow-green" d="M1085 752 H1150 V775 H1200"/>

      <rect class="box" x="20" y="1260" width="1560" height="120" rx="10"/><text class="ink" x="45" y="1290">Transaction -> driver -> DUT pins</text>
      <rect class="blue" x="60" y="1310" width="390" height="48" rx="7"/><text class="ink" x="255" y="1330" text-anchor="middle">isptx_transaction : id + 9b data / 18b two_data / controls</text><text class="small" x="255" y="1350" text-anchor="middle">created by uvm_do_with in sequence tasks</text>
      <rect class="amber" x="600" y="1310" width="430" height="48" rx="7"/><text class="ink" x="815" y="1330" text-anchor="middle">isptx_driver main_phase :879</text><text class="small" x="815" y="1350" text-anchor="middle">dispatch id -> convert_one/sec_bit :758/784 -> 9 clocks</text>
      <rect class="green" x="1180" y="1310" width="350" height="48" rx="7"/><text class="ink" x="1355" y="1330" text-anchor="middle">chip_tb_top -> u_HV2M23</text><text class="small" x="1355" y="1350" text-anchor="middle">b_if.rxp/rxn0/1 -> APAD_RXP/RXN0/1</text>
      <path class="arrow" d="M450 1334 H600 M1030 1334 H1180"/><path class="arrow" d="M580 1195 V1240 H255 V1310"/>
    """
    checker_position = """
    ...
    """
    diagrams = {
        "architecture.svg": svg_document(1400, 920, architecture, "HV2M23 UVM verification environment hierarchy"),
        ...
        "isptx-sequence-overview.svg": svg_document(1400, 900, isptx_sequence_overview, "ISPTX sequence source overview"),
        "isptx-sequence-detail.svg": svg_document(1600, 1400, isptx_sequence_detail, "Detailed ISPTX sequence source execution flow"),
...
python regression_cov.py</code></pre>
    ...
    scripts_body = """
      ...
      <div class="stats"><div class="stat"><strong>48</strong><span>active script files</span></div><div class="stat"><strong>26</strong><span>Python (.py)</span></div><div class="stat"><strong>18</strong><span>Shell (.sh)</span></div><div class="stat"><strong>4</strong><span>Perl (.pl)</span></div></div>
      <p>统计范围为整个 <code>E:/DV_TCON_C</code>。源码树实际找到 81 个 <code>.py/.sh/.pl</code> 文件；上面的 48 个有效副本排除了 <code>top/tests/tests</code> 下的历史镜像和 <code>cmodel_bk</code> 备份。镜像脚本应只用于追溯，日常修改以非备份路径为准。</p>
      <h2>脚本总览</h2>
      ...
      <h2>Shell 脚本（.sh）</h2>
      <div class="table-scroll"><table class="script-table"><tr><th>脚本/脚本组</th><th>用途</th><th>调用方式</th><th>风险与说明</th></tr>
      <tr><td><code>script/run_tc.sh</code></td><td>仿真总入口；建立结果目录、复制 makefile、清理产物并调用对应 make target。</td><td><code>run_tc.sh &lt;level&gt; &lt;case&gt; chip_tb_top &lt;action&gt; [clean]</code></td><td>会清理目标 case 的旧 PPM、outResult 和部分仿真结果。</td></tr>
      <tr><td><code>top/agents/isprx_env/cmodel/Run.sh</code></td><td>从 testcase 的 <code>user_def.sv</code> 读取 HACT/VACT/PORT/PAIR/POLC/SHL 等宏，逐帧调用 <code>pic_process</code>。</td><td><code>Run.sh &lt;case&gt; &lt;TOP mode&gt;</code></td><td>输入 pattern 和输出 outResult 依赖当前仿真目录；检查 frame 数及宏值。</td></tr>
      <tr><td><code>top/agents/cmodel/.../build_all_prj.sh</code></td><td>批量 build、clean 或运行各芯片 pic_split_transform 工程。</td><td><code>sh build_all_prj.sh all|clean|run</code></td><td>当前源码的 <code>run</code> 条件写法应在使用前复核；<code>cmodel_bk</code> 是备份副本。</td></tr>
      <tr><td><code>top/agents/cmodel/.../&lt;project&gt;/Run.sh</code></td><td>HK1V11、HK2M22、HV1V21、HV1V22、HV1V31、HV2A31、HV2M23、HV3310B1 的模型示例命令。</td><td>进入对应项目目录执行 <code>sh Run.sh</code></td><td>多数包含固定尺寸或历史绝对路径，属于项目示例，不应直接当回归入口。</td></tr>
      <tr><td><code>top/tests/create_new_case.sh</code></td><td>从 <code>t_8b1lane</code> 克隆 case，并按 case 名解析分辨率、pair、DPLC、chopper 和寄存器字段。</td><td><code>./create_new_case.sh &lt;new_case_name&gt;</code></td><td>会批量复制、替换、重命名并修改 cfg/SV；只应在 tests 根目录和干净工作区执行。</td></tr>
      <tr><td><code>top/tests/copy_test.sh</code></td><td>复制已有 testcase，替换内部名称并删除 Verdi 临时文件。</td><td><code>./copy_test.sh &lt;old_case&gt; &lt;new_case&gt;</code></td><td>使用递归文本替换；pattern/golden 被排除，复制后需人工检查资产。</td></tr>
      <tr><td><code>top/tests/produce.sh</code></td><td>串联 <code>produce_case.py</code> 和 <code>produce_isp_register.py</code> 生成 testcase。</td><td><code>./produce.sh &lt;case&gt; &lt;register.csv&gt;</code></td><td>脚本头中的旧项目示例仅供参数格式参考。</td></tr>
      <tr><td><code>top/tests/creat_cases.sh</code></td><td>按固定命名规则批量复制 DPLC case 并修改宏、文件名和寄存器内容。</td><td>在 tests 根目录直接执行</td><td>一次修改多个目录，且当前文件含历史编码文本；使用前必须审核匹配范围。</td></tr>
      <tr><td><code>*/pattern/run_gen_pattern.sh</code></td><td>调用同目录 <code>gen_pattern.py</code> 生成特定 case 的 PPM pattern。</td><td>进入对应 pattern 目录执行</td><td>属于 case-local 工具，尺寸和输出名只适用于对应 testcase。</td></tr>
      <tr><td><code>top/agents/cmodel/test/HV2A31/Run.sh</code></td><td>HV2A31 CModel 测试示例。</td><td>进入测试目录执行</td><td>非 HV2M23 主流程；保留用于模型回归参考。</td></tr></table></div>

      <h2>Perl 脚本（.pl）</h2>
      <div class="table-scroll"><table class="script-table"><tr><th>脚本</th><th>用途</th><th>命令示例</th><th>产物/注意事项</th></tr>
      <tr><td><code>script/user_def_addon.pl</code></td><td>合并基础 user_def 与 addon 宏，同名 define 使用 addon 值。</td><td><code>perl user_def_addon.pl base.sv addon.sv &gt; merged.sv</code></td><td>只处理单行 define；结果输出到 stdout。</td></tr>
      <tr><td><code>top/agents/isprx_env/cmodel/dplc.pl</code></td><td>读取 P3 PPM，按 duplicate/average 等参数生成 DPLC golden。</td><td><code>perl dplc.pl --mode=... --input=in.ppm --output=out.ppm ...</code></td><td>参数契约应以 sequence 实际拼接命令为准；会检查 PPM 像素数量。</td></tr>
      <tr><td><code>top/agents/isprx_env/regen_register_for_simulation.pl</code></td><td>从 flat register 文本生成 I2C/ISP simulation cfg、default/invert check 和 get 映射文本。</td><td><code>perl regen_register_for_simulation.pl &lt;flat_register.txt&gt;</code></td><td>在当前目录覆盖多个 <code>register_for_simulation_*.txt</code> 文件。</td></tr>
      <tr><td><code>top/tests/t_debugpin/gen_test.pl</code></td><td>读取 debugpin 列表，生成逐项 force 和 DTESTO 检查代码。</td><td><code>perl gen_test.pl debugpin.list</code></td><td>生成 <code>debugpin.v</code>；RTL 层次路径为 HV2M23 专用，修改 mapping 前必须核对 RTL。</td></tr></table></div>

      <h2>Python 脚本（.py）完整分类</h2>
      <table><tr><th>类别</th><th>脚本</th><th>说明</th></tr>
      <tr><td>运行与回归</td><td><code>regression.py</code>、<code>regression_cov.py</code>、<code>run_case.py</code>、<code>run_input_test.py</code>、<code>run_parallel.py</code>、<code>run_tests_mondisp.py</code>、<code>run_tests_unlock_utc.py</code></td><td>普通/coverage/专项/并行运行入口；有的使用参数，有的使用脚本内 case 数组。</td></tr>
      <tr><td>结果与 coverage</td><td><code>script/check.py</code>、<code>script/merge_coverage.py</code></td><td>汇总日志并合并 VDB；不替代原始日志复核。</td></tr>
      <tr><td>Case 与寄存器生成</td><td><code>produce_case.py</code>、<code>produce_isp_register.py</code>、<code>produce_isp_register_all.py</code>、<code>produce_all_register.py</code>、<code>user_def_register.py</code>、<code>user_def_register_rx.py</code></td><td>从命名、CSV 或 diff 资产生成 testcase、cfg 和寄存器相关文件。</td></tr>
      <tr><td>环境与 RGM 维护</td><td><code>generate_env_cfg.py</code>、<code>update_env_cfg.py</code>、<code>extract_register_names.py</code>、<code>produce_rgl.py</code>、<code>script/produce_checker1.py</code></td><td>生成/更新 env_cfg、寄存器名、RGM 和 checker 骨架；可能覆盖源码文件。</td></tr>
      <tr><td>DRDOD 与 pattern</td><td><code>drdod_process.py</code>、<code>gen_ppm.py</code>、case-local <code>gen_pattern.py</code>、<code>analog_separate.py</code></td><td>生成或处理 PPM；参数、尺寸和通道格式需与对应 case/sequence 对齐。</td></tr>
      <tr><td>专项维护</td><td><code>remove.py</code></td><td>当前指向 <code>_test_sv</code> fixture 并批量注释指定代码，属于维护实验工具，不是正常回归入口。</td></tr></table>
      <div class="note"><strong>重复目录：</strong><code>top/tests/tests</code> 中存在一套历史脚本和 DRD smoke pattern 工具镜像，<code>top/agents/cmodel_bk</code> 中存在 CModel Shell 备份。除非正在对比历史版本，否则不要在这些目录修改或执行脚本。</div>
...
artifacts/          # run-id/frame-id scoped golden and actual outputs</code></pre>
    ...
    return {
        ...
        "scripts.html": page("scripts.html", "脚本使用指南", "完整整理 Python、Shell 和 Perl 脚本，说明仿真、模型、回归、生成维护和专项工具的输入、命令、产物与风险。", scripts_body),
